...
vec3 photoTwinkleLight(vec3 photoColor, vec2 photoUv) {
  ...
  for (int i = 0; i < ${E.capacity}; i++) {
    ...
    float alpha = (core * ${E.coreOpacity.toFixed(4)} + halo * ${E.haloOpacity.toFixed(4)}) * star.w * taper;
