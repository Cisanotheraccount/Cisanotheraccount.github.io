...
import { workProjects, portfolioContact, type PortfolioProject } from '../portfolioData';
...
export function NextPortfolio() {
  ...
  useLayoutEffect(() => {
    document.title = project ? project.title + ' — Gala X Ci' : 'Gala X Ci — Ci Song / Design & exploration';
  }, [project]);
  useEffect(() => {
