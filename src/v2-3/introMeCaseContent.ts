...
export const introMePresentation = localizeMain({
...
export const introMeMedia = localizeMain({
...
export const introMeExplorations = localizeMain([
...
export const introMeRecordingStates = localizeMain([
  { label: 'Listening', duration: '15s' },
  { label: 'Speaking', duration: '90s' },
  { label: 'Idle', duration: '15s' },
]);

export const introMeKnowledge = localizeMain([
...
export const introMeVoice = localizeMain([
...
export const introMeIntent = localizeMain([
...
export const introMeLimits = localizeMain([
